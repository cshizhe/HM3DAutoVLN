...
def parse_args():
    ...
    parser.add_argument('--root_dir', type=str, default='/sequoia/data3/shichen/datasets')
    ...
    parser.add_argument('--hm3d_scan_ranges', nargs='+', type=int, default=None)
    parser.add_argument('--hm3d_og_loss_weight', type=float, default=1)


    parser.add_argument('--num_mp3d_scans', default=None, type=int)
...
def postprocess_args(args):
    ...
    # Setup input paths
    ft_file_map = {
        'timm_vitb16': 'view_timm_imagenet_vitb16',
        'mmdet2d_frcnn_hm3d': 'obj_gtmax_mmdet2d_frcnn_hm3d/views',
    }
    args.img_ft_file = os.path.join(ROOTDIR, 'REVERIE', 'features', ft_file_map[args.features])
    if not os.path.exists(args.img_ft_file):
        args.img_ft_file = os.path.join(ROOTDIR, 'R2R', 'features', ft_file_map[args.features])

    obj_ft_file_map = {
        'timm_vitb16': 'obj_gtmax_timm_imagenet_vitb16',
        'mmdet2d_frcnn_hm3d': 'obj_gtmax_mmdet2d_frcnn_hm3d/gt_objs',
    }
